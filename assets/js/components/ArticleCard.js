...
export default defineComponent({
  ...
  template: `
    <a :href="getArticleUrl()" 
       ...
       class="bg-white rounded-2xl p-8 shadow-sm border-r-4 border-b-4 border-slate-400 hover:shadow-lg hover:-translate-y-1 hover:border-slate-500 transform transition-all duration-200">
